...
@Autonomous(name="Something Cool", group ="Concept")
//@Disabled
public class AutoMarsRover extends LinearOpMode {

    org.firstinspires.ftc.teamcode.HardwarePushbot robot = new org.firstinspires.ftc.teamcode.HardwarePushbot();

    private static final String VUFORIA_KEY = "\n";
    ...
    private static final double mmSquareWidth = (23.5) * mmPerInch;
    ...
    private void findGoldBlock(){

        while(lastLocation.getTranslation().get(0) / mmPerInch < 23.5) {
